...
namespace TicketWeb.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<TicketWebUser> signInManager,
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} dài từ {2} đến {1} .", MinimumLength = 3)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new TicketWebUser { UserName = Input.Email, Email = Input.Email };
